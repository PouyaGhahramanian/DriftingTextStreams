...
def generate_and_save_stream(filename_in, filename_out, label_column, drift_type, drift_start, drift_end, drift_intensity, drift_func,
    ...
    drifter_instances = [Drifter(labels, drift_type, drift_start, drift_end, drift_intensity,
    ...
    for i in range(data_size):
        ...
        for j in range(labels_num):
            labels_drifting[i, j] = drifter_instances[j].get_label(i)
...
if __name__ == '__main__':
    ...
    filename_out = "../data_output/turkish_news_multilabel.csv.gz"
